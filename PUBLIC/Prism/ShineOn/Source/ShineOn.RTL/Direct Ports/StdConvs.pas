...
method FahrenheitToCelsius(const AValue: Double): Double;
method CelsiusToFahrenheit(const AValue: Double): Double;
...
method KelvinToCelsius(const AValue: Double): Double;
begin
  Result := AValue - 273.15;
end;

method CelsiusToKelvin(const AValue: Double): Double;
begin
  Result := AValue + 273.15;
end;

method RankineToCelsius(const AValue: Double): Double;
begin
  Result := FahrenheitToCelsius(AValue - 459.67);
end;

method CelsiusToRankine(const AValue: Double): Double;
begin
  Result := CelsiusToFahrenheit(AValue) + 459.67;
end;

method ReaumurToCelsius(const AValue: Double): Double;
begin
  Result := FahrenheitToCelsius(((AValue * 9) / 4) + 32);
end;

method CelsiusToReaumur(const AValue: Double): Double;
begin
  Result := ((CelsiusToFahrenheit(AValue) - 32) * 4) / 9;
end;

method ConvDateTimeToJulianDate(const AValue: Double): Double;
begin
  Result := DateTimeToJulianDate(AValue);
end;

method ConvJulianDateToDateTime(const AValue: Double): Double;
begin
  Result := JulianDateToDateTime(AValue);
end;

method ConvDateTimeToModifiedJulianDate(const AValue: Double): Double;
begin
  Result := DateTimeToModifiedJulianDate(AValue);
end;

method ConvModifiedJulianDateToDateTime(const AValue: Double): Double;
begin
